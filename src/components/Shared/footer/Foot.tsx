  ...
  return (
    ...
    <div className="h-full w-full flex flex-col items-center  justify-center">
      ...
      <div className='flex flex-wrap md:flex-row flex-col w-full '>
               ...
               <div className='flex-1 px-[20px] border-r border-gray-200'>
                         <div className="col-span-1 text-center md:text-start md:justify-start md:items-start flex flex-col justify-center items-center ">
                            <h1 className="text-blue-950 md:text-[30px] text-[20px] font-bold py-4" >EastwindTrust</h1>
                             <p className="text-blue-950 pb-2 pt-4">
                      ...
                      <div className='flex flex-row w-full gap-3 md:items-start md:justify-start items-center justify-center'>
                               <div className='border-gray-200 border p-2 cursor-pointer'><FaFacebook className='h-[25px] w-[25px] text-blue-950'/></div>
                               <div className='border-gray-200 border p-2 cursor-pointer'><FaTwitter className='h-[25px] w-[25px] text-blue-950'/></div>
                               <div className='border-gray-200 border p-2 cursor-pointer'><FaInstagram className='h-[25px] w-[25px] text-blue-950'/></div>
                               <div className='border-gray-200 border p-2 cursor-pointer'><FaLinkedin className='h-[25px] w-[25px] text-blue-950'/></div>
                        </div>
                          </div>
               </div>
        ...
        <div className="col-span-1 text-center md:text-start md:justify-start md:items-start flex flex-col justify-center items-center ">
          <h1 className="text-blue-950 md:text-[30px] text-[20px] font-bold py-4" >Quick Links</h1>
        ...
        <div className="col-span-1 md:ml-12 text-center md:text-start">
          <h1 className="font-semibold text-blue-950  md:text-[30px] text-[20px]   py-4 ">Useful Links</h1>
          <div className="flex flex-col text-blue-950">
            {navLinks.map((link) => (
              <Link href={link.href} key={link.name} className="py-2">
                {link.name}
          ...
          <h1 className="font-semibold text-blue-950 py-4 md:text-[30px] text-[20px]  ">Shop</h1>
         <div className="flex flex-col text-blue-950">
            {navLinks.map((link) => (
              <Link href={link.href} key={link.name} className="py-2">
                {link.name}
        ...
        <div className="col-span-1 text-center md:text-start">
          <h1 className="font-semibold  text-blue-950 md:text-[30px] text-[20px] py-4  ">Contact </h1>
          <div className='flex flex-row w-full gap-2 py-2 justify-center items-center md:items-start md:justify-start'>
            <div className='border-gray-200 border p-2 cursor-pointer'><BiPhoneCall className='h-[25px] w-[25px] text-blue-950'/></div>
            <p className="py-2 text-blue-950">078565789 </p>
          </div>

          <div className='flex flex-row w-full gap-2 py-2 justify-center items-center md:items-start md:justify-start'>
            <div className='border-gray-200 border p-2 cursor-pointer'><BiMapPin className='h-[25px] w-[25px] text-blue-950'/></div>
            <p className="py-2 text-blue-950">Harare</p>
          </div>
      ...
      <div className="w-full px-[20px] text-center py-5 flex md:flex-row flex-col  justify-between items-center">
        ...
        <div className="py-8 text-blue-950">&copy; 2025 All rights reserved | EastwindTrust  </div>
        <div className='flex flex-row text-blue-950 gap-2 items-center justify-center '>
